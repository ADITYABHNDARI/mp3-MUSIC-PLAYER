...
def add_song():
	song = filedialog.askopenfilename(initialdir='folder in which songs are', title="Choose A Song", filetypes=(("mp3 Files", "*.mp3" ), ))
	# Strip out directory structure and .mp3 from song title
	song = song.replace("C:/mp3/audio/(sample directory)", "")
...
def play():
	...
	# Reconstruct song with directory structure stuff
	song = playlist_box.get(ACTIVE)
	song = f'C:/mp3/audio/{song}.mp3(your song location)'
